...
/**
 * Unit tests for fieldfrommoddata element.
 *
 * @package    certificateelement_fieldfrommoddata
 * @group      tool_certificate
 * @covers     \certificateelement_fieldfrommoddata\element
...
final class element_test extends advanced_testcase {
    ...
    public function test_render_html(): void {
        ...
        $formdata = ['name' => 'Field element', 'moddataid' => '',
            'fieldname' => '', ];
        $e = $this->get_generator()->create_element($pageid, 'fieldfrommoddata', $formdata);
